...
const { startPersonalTodoReminderScheduler } = require("./services/personalTodoReminderService");
...
server.listen(env.apiPort, env.apiHost, () => {
  ...
  // Personal to-do card alarms. Ticks every minute rather than once a day —
  // these fire at a time of day the user picked themselves.
